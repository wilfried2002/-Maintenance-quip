...
import ModuleDashboard from '@/Components/Modules/ModuleDashboard.vue';
...
const navLinks = [
    { label: 'Tableau de bord', href: route('equipements-bureau.dashboard'), icon: 'fa-tachometer-alt', active: true },
...
<template>
    <Head title="Tableau de bord — Équipement de bureau" />
    ...
    <AuthenticatedLayout>
        ...
        <div class="py-12">
            <div class="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
                <ModuleDashboard theme="blue" :stats="stats" />
            </div>
        </div>
    </AuthenticatedLayout>
</template>
